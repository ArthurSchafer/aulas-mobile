...
export default function App() {
  ...
  function somar(n1, n2){
    ...
    const n1Convertido = parseFloat(n1);
    const n2Convertido = parseFloat(n2);
    const diminui = n1Convertido - n2Convertido;
    return diminui;
  }
    ...
    const n1Convertido = parseFloat(n1);
    const n2Convertido = parseFloat(n2);
    const div = n1Convertido / n2Convertido;
    if(n2 == 0){
      return "Não é possivel converter esse número";
    }else{
    return div;
  }
}
  ...
  return (
    <SafeAreaView style={estilos.areaSegura}>
      ...
      <View style={estilos.botoes}>
        ...
        <Button title=" Resetar " onPress={() => setResultado(0)}/>
      </View>
